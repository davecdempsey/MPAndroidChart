...
public class RadarHighlighter extends PieRadarHighlighter<RadarChart> {
    ...
    @Override
    protected Highlight getClosestHighlight(int index, double x, double y) {
    ...
    protected List<Highlight> getHighlightsAtIndex(int index) {
        ...
        double phaseX = mChart.getAnimator().getPhaseX();
        double phaseY = mChart.getAnimator().getPhaseY();
